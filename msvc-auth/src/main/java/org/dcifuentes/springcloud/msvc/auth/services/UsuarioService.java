package org.dcifuentes.springcloud.msvc.auth.services;

import org.dcifuentes.springcloud.msvc.auth.models.Usuario;
...
public class UsuarioService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        try{
            ...
            log.info("Usuario pass: " + usuario.getPassword());
