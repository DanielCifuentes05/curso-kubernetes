package org.dcifuentes.springcloud.msvc.usuarios.controllers;

import feign.Response;
import jakarta.validation.Valid;
import org.dcifuentes.springcloud.msvc.usuarios.models.entity.Usuario;
import org.dcifuentes.springcloud.msvc.usuarios.services.UsuarioService;
    ...
    public ResponseEntity<?> crear(@Valid @RequestBody Usuario usuario, BindingResult result){
        ...
        if(!usuario.getEmail().isEmpty() && service.existePorEmail(usuario.getEmail())){
            return ResponseEntity.badRequest()
                    .body(Collections
                            .singletonMap("mensaje","El correo electronico ya esta registrado"));
        }
